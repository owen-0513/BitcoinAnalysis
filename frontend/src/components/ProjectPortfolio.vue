<template>
  <div class="portfolio">
    ...
    <router-link to="/bitcoin" class="btn secondary-btn">SMC虛擬貨幣分析</router-link>
  </div>
</template>
...
.portfolio {
  text-align: center;
  padding: 60px 20px;
  background: linear-gradient(to right, #f6f9fc, #e9f3fa);
  min-height: 100vh;
}
...
.primary-btn:hover {
  background: linear-gradient(to right, #0056b3, #009dd4);
